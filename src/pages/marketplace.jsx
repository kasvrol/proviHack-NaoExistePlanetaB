        ...
        <>
            ...
            <main className="marketplaceContainer">
                ...
                <div className="marketplaceText">
                    <p>
                        Olá, ficamos muito felizes com a sua presença por aqui!
                    </p>
                    <p>
                    ...
                    <ul>
                        <li>
                            Nossas voluntárias coletam e distribuem os tecidos
                            em horário comercial, os tecidos deverão estar em
                            caixas ou sacolas possíveis de se carregar.
                        </li>
                        <li>
                            Não coletamos insumos que não possam ser
                            reaproveitados, por este motivo elas revisam os
                            itens antes de serem retirados.
                        </li>
                        <li>
                            Nossa plataforma conta com seu apoio, portanto é
                            necessário que para realizar doações cada
                            empresário/comerciante realize o pagamento de uma
                            taxa anual de R$300. Essa taxa é essencial para que
                            possamos custear nossos profissionais que mantêm
                            esta plataforma em funcionamento.
                        </li>
                    </ul>
                    <div className="merchanCards">
                        <div className="BusinessCard">
                            ...
                            <img
                                src={image14}
                                alt="dois homens fazendo negócio"
                            />
                            <p>
                                Lembre-se a sua contribuição é muito importante
                                para que nós possamos continuar dando um destino
